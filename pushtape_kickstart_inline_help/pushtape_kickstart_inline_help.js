(function ($) {
  ...
  $(function () {
    Drupal.ajax.prototype.commands.pushtape_kickstart_inline_help_open = Drupal.KickstartHelp.Kickstart_display_open;
    Drupal.ajax.prototype.commands.pushtape_kickstart_inline_help_close = Drupal.KickstartHelp.Kickstart_display_close;
  });
  ...
  Drupal.KickstartHelp.Kickstart_display_open = function (ajax, response, status) {
    ...
    textArea = $('#pushtape-kickstart-inline-help');
    openButton = $('#pushtape-kickstart-inline-help-button #edit-pushtape-kickstart-inline-help-button');
    openButtonContainer = $('#pushtape-kickstart-inline-help-button');
    closeButton = $('#edit-pushtape-kickstart-inline-help-close-button');
  ...
  Drupal.KickstartHelp.show = function() {
    ...
    // Check if the help section is hidden. If so, hide the open button.
      if ($('#pushtape-kickstart-inline-help').is(":visible")) {
        $('#pushtape-kickstart-inline-help-button').hide();
      }
  ...
  Drupal.behaviors.KickstartHelp = {
    attach:function (context) {
      $('#pushtape-kickstart-inline-help').once('help-processed', function() {
